    ...
    >
      <Form>
        <div className="container w-full">
          ...
          <button className="px-6 py-2 mt-4 font-bold text-white bg-red-700 rounded shadow-sm hover:bg-red-500 focus:shadow-outline focus:outline-none" type="submit">
            Enviar mensagem
          </button>
        </div>
      </Form>
